!!! OLD - удаляю из проекта, перенеся весь код в .h (т.к. это шаблон - след-но всё m!b. в одном файле) (ну или надо было подключать в использующие файлы вместо .h-файла .cpp-файл, к которому обычно инклудить вначале .h)
